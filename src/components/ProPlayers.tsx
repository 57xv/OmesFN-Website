...
const players = [
    { name: "Kai", img: "/images/pro-players/kai.gif", role: "lifetime" },
    { name: "FluxRSA", img: "/images/pro-players/flux.png", role: "lifetime" },
    { name: "Mario-", img: "/images/pro-players/mario.gif", role: "trial" },
    { name: "Noel", img: "/images/pro-players/noel.png", role: "weekly" },
    { name: "Kqnan", img: "/images/pro-players/kqan.png", role: "monthly" },
    { name: "Icollect", img: "/images/pro-players/ico.png", role: "lifetime" },
];
        ...
        <section id="players" className="py-32 bg-black relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 mb-20">
                ...
                >
                    ...
                    >
                        <span className="text-primary text-[10px] font-black uppercase tracking-[0.3em]">Our Buyers</span>
                    </motion.div>
