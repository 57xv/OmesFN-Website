...
export function Navbar() {
    ...
    const toggleLang = () => {
        setLanguage(language === "en" ? "pt" : language === "pt" ? "fr" : "en");
    };
            ...
            <div className={`container mx-auto px-6 transition-all duration-500 ${scrolled ? "max-w-6xl" : "max-w-7xl"}`}>
                <div className={`flex items-center justify-between px-6 py-3 rounded-2xl transition-all duration-500 ${scrolled ? "glass-dark shadow-2xl border-white/10" : "bg-transparent border-transparent"}`}>
                    ...
                    <Link href="/" className="flex items-center gap-2 group">
                        <span className="text-2xl md:text-3xl font-black text-primary tracking-wider group-hover:drop-shadow-[0_0_8px_rgba(31,192,88,0.5)] transition-all duration-300">OmesFN</span>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        >
                            <img
                                src={language === "en" ? "/images/flags/ca.png" : language === "pt" ? "/images/flags/br.png" : "/images/flags/fr.png"}
                                alt={language === "en" ? "Canada Flag" : language === "pt" ? "Brazil Flag" : "France Flag"}
                                className="w-5 h-3 rounded-sm object-cover transition-transform group-hover:scale-110"
                            />
