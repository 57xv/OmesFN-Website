                ...
                >
                    ...
                    >
                        <div className="relative">
                            <img src="/images/flags/ca.png" alt="Canada" className="w-5 h-3 rounded-sm relative z-10" />
                            <div className="absolute inset-0 bg-primary/40 blur-sm rounded-sm animate-pulse"></div>
                        </div>
                        <span className="text-primary text-[11px] font-black tracking-[0.2em] uppercase">Fortnite Checker</span>
                    </motion.div>
                    ...
                    >
                        <span className="text-5xl md:text-7xl font-black text-primary tracking-wider drop-shadow-[0_0_35px_rgba(31,192,88,0.4)] transition-transform duration-700 hover:scale-105">OmesFN</span>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        className="text-lg md:text-2xl text-gray-300 max-w-2xl mx-auto mb-12 font-medium leading-relaxed tracking-tight"
                    >
                        {t.hero.subtitle}
                    </motion.p>
