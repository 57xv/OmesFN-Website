            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-start gap-20">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-medium mb-12 max-w-2xl">
                            {t.about.description}
                        </p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-16">
                            ...
                            >
                                ...
                                <h3 className="text-5xl font-black text-primary mb-2 tracking-tight">300+</h3>
                        ...
                        <div className="pt-12 border-t border-white/10">
                            ...
                            <div className="flex flex-wrap gap-12">
                                {/* Blxckoutz */}
                                <a href="https://frozi.lol/og" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group">
                                    <div className="relative">
                                        ...
                                        <div className="relative w-20 h-20">
                                            <img src="/images/avatars/r3nm4rss.png" alt="r3nm4rss" className="w-full h-full rounded-2xl border-2 border-white/10 group-hover:border-primary transition-all duration-500 object-cover relative z-10" />
                                            <div className="absolute -bottom-2 -right-2 bg-black rounded-lg p-1 z-20 shadow-xl border border-white/10">
                                                <img src="/images/flags/ca.png" alt="Canada" className="w-6 h-4 rounded-sm" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col">
                                        <div className="flex items-center gap-2">
                                            <span className="font-heading font-black text-xl text-white group-hover:text-primary transition-colors tracking-tight">@r3nm4rss</span>
                                            <img src="/images/icons/verified.png" alt="Verified" className="w-5 h-5 drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]" />
                                        </div>
                                        <span className="text-xs font-black text-gray-500 group-hover:text-gray-400 transition-colors uppercase tracking-widest">Owner</span>
                                    </div>
                                </a>
                                ...
                                <a href="https://idarko.xyz" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group">
                                    <div className="relative">
                                        <div className="absolute inset-0 bg-primary/30 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 scale-110" />
                                        <div className="relative w-20 h-20">
                                            <img src="/images/avatars/darko.png" alt="Gorilon" className="w-full h-full rounded-2xl border-2 border-white/10 group-hover:border-primary transition-all duration-500 object-cover relative z-10" />
                                            <div className="absolute -bottom-2 -right-2 bg-black rounded-lg p-1 z-20 shadow-xl border border-white/10">
                                                <img src="/images/flags/ca.png" alt="Canada" className="w-6 h-4 rounded-sm" />
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex flex-col">
                                        <div className="flex items-center gap-2">
                                            <span className="font-heading font-black text-xl text-white group-hover:text-primary transition-colors tracking-tight">@fwdarko</span>
                                            <img src="/images/icons/verified.png" alt="Verified" className="w-5 h-5 drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]" />
                                        </div>
                                        <span className="text-xs font-black text-gray-500 group-hover:text-gray-400 transition-colors uppercase tracking-widest">Owner</span>
                                    </div>
                    ...
                    >
                        <div className="relative aspect-square flex items-center justify-center glass rounded-[40px] border-white/10 overflow-hidden shadow-2xl group">
                            ...
                            <span className="text-6xl font-black text-primary opacity-20 group-hover:opacity-60 transition-all duration-1000 group-hover:scale-110">OmesFN</span>
